...
const CONTINENTS: [number, number][][] = [
  // North America
  [
    [-168*D,72*D],[-140*D,70*D],[-95*D,75*D],[-65*D,68*D],[-55*D,47*D],
    [-52*D,47*D],[-66*D,45*D],[-82*D,42*D],[-80*D,25*D],[-87*D,16*D],
    [-77*D,8*D],[-105*D,20*D],[-117*D,32*D],[-120*D,37*D],[-124*D,49*D],
    [-130*D,54*D],[-140*D,58*D],[-153*D,58*D],[-168*D,62*D],[-168*D,72*D],
  ],
  // South America
  [
    [-81*D,8*D],[-63*D,11*D],[-50*D,5*D],[-35*D,-5*D],[-35*D,-8*D],
    [-37*D,-12*D],[-40*D,-20*D],[-50*D,-28*D],[-55*D,-32*D],[-58*D,-38*D],
    [-62*D,-42*D],[-65*D,-46*D],[-66*D,-55*D],[-68*D,-55*D],[-72*D,-48*D],
    [-76*D,-45*D],[-72*D,-38*D],[-70*D,-32*D],[-70*D,-20*D],[-75*D,-10*D],
    [-81*D,0*D],[-81*D,8*D],
  ],
  // Europe
  [
    [-10*D,36*D],[0*D,36*D],[10*D,37*D],[15*D,38*D],[28*D,42*D],
    [30*D,46*D],[25*D,50*D],[22*D,55*D],[25*D,60*D],[28*D,65*D],
    [20*D,70*D],[10*D,65*D],[5*D,58*D],[0*D,51*D],[5*D,50*D],
    [10*D,54*D],[15*D,54*D],[20*D,55*D],[22*D,58*D],[18*D,63*D],
    [15*D,70*D],[10*D,72*D],[0*D,60*D],[-5*D,55*D],[-10*D,50*D],
    [-8*D,43*D],[-10*D,36*D],
  ],
  // Africa
  [
    [-17*D,15*D],[-15*D,10*D],[-15*D,5*D],[-10*D,-2*D],[-10*D,-10*D],
    [-15*D,-15*D],[-20*D,-20*D],[-30*D,-28*D],[-32*D,-30*D],[-26*D,-35*D],
    [20*D,-35*D],[35*D,-26*D],[38*D,-20*D],[42*D,-12*D],[43*D,-5*D],
    [42*D,5*D],[42*D,10*D],[42*D,12*D],[38*D,15*D],[32*D,20*D],
    [28*D,28*D],[34*D,30*D],[36*D,35*D],[25*D,38*D],[15*D,38*D],
    [10*D,37*D],[0*D,36*D],[-5*D,35*D],[-10*D,35*D],[-17*D,21*D],[-17*D,15*D],
  ],
  // Asia
  [
    [25*D,38*D],[35*D,37*D],[37*D,35*D],[55*D,25*D],[60*D,22*D],
    [73*D,20*D],[80*D,12*D],[80*D,20*D],[90*D,22*D],[100*D,20*D],
    [105*D,15*D],[110*D,10*D],[117*D,4*D],[120*D,10*D],[125*D,15*D],
    [130*D,15*D],[135*D,34*D],[140*D,37*D],[145*D,44*D],[150*D,54*D],
    [140*D,62*D],[135*D,55*D],[130*D,50*D],[120*D,52*D],[100*D,58*D],
    [80*D,62*D],[60*D,58*D],[50*D,50*D],[40*D,50*D],[35*D,45*D],
    [28*D,45*D],[25*D,42*D],[25*D,38*D],
  ],
  // Australia
  [
    [114*D,-22*D],[120*D,-18*D],[130*D,-12*D],[136*D,-12*D],[140*D,-18*D],
    [142*D,-25*D],[145*D,-30*D],[150*D,-35*D],[152*D,-32*D],[155*D,-28*D],
    [150*D,-25*D],[148*D,-22*D],[142*D,-18*D],[138*D,-18*D],[136*D,-22*D],
    [130*D,-28*D],[122*D,-34*D],[114*D,-32*D],[112*D,-26*D],[114*D,-22*D],
  ],
  // Antarctica
  [
    [-180*D,-70*D],[-120*D,-68*D],[-60*D,-70*D],[0*D,-72*D],[60*D,-70*D],
    [120*D,-68*D],[180*D,-70*D],[180*D,-75*D],[120*D,-75*D],[60*D,-75*D],
    [0*D,-75*D],[-60*D,-75*D],[-120*D,-75*D],[-180*D,-75*D],
  ],
];
